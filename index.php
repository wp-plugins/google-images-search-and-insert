		...
		<div id="vgis_popup" style="width: 950px; height: 440px; position: relative; overflow: hidden">
			<div style="width: 640px;height: 420px; float: left; padding: 10px 0 10px 10px;">
				...
				<div style="width:98%; display: inline-block; margin-top: 5px; height:28px; line-height: 28px;"><span
						style="float:left; margin-right: 10px;"><input name="vgiscc" id="vgiscc" type="checkbox"/> Only Creative Commons</span>
					<input type="text" id="vgisinput" name="vgisinput" value="" size="30"/>
					<input type="button" id="vgissearch" class="button" value="Search"/>
			...
			<div
				style="width: 274px; height: 420px; position: absolute; top: 0; right: 0; padding: 10px; border-left: 1px solid #ddd;background: #fcfcfc;">
				<div id="vgis-use-image" class="vgis-use-image">
					...
					<p class="vgis-p">Caption
						<textarea id="vgis-caption" name="vgis-caption" style="width:220px;"></textarea>
					</p>

					<p class="vgis-p">
						File name <select name="vgis-filename" id="vgis-filename"/>
					...
					<p class="vgis-p">
						Width
						<input type="text" id="vgis-width" size="8" value="0"/>
						x Height <input type="text" id="vgis-height" size="8" value="0"/>
					</p>

					<p class="vgis-p">
						Alignment
						<select name="vgisalign" id="vgisalign">
					...
					<p class="vgis-p">
						Link to
						<select name="vgislink" id="vgislink">
					...
					<p class="vgis-p">
						<input name="vgisblank" id="vgisblank" type="checkbox"/> Open new windows &nbsp;
						<input name="vgisnofollow" id="vgisnofollow" type="checkbox"/> Rel nofollow
					</p>
					...
					<p class="vgis-p" style="margin-top: 20px;">
						...
						<a class="skip button-secondary" href="javascript:void(0);"
						   onclick="javascript:alert('Buy full version to use this feature!\nPlease goto http://dunghv.com');"
						   title="Only available in full version!" target="_blank">Save & Insert</a>
						<input type="button" id="vgisfeatured" class="button button-primary" value="Set Featured"/>
					</p>
